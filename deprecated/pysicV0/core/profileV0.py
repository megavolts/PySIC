...
# -*- coding: utf-8 -*-
"""
pysic.core.profileV0.py : toolbox to work on property profile
...
__status__ = "dev"
__date__ = "2017/09/13"
__comment__ = "profileV0.py contained function to handle property profile"
__CoreVersion__ = 1.1
...
def select_variables(ics_stack, variables):
    ...
    if stack_type == 'Profile':
        return pysic.core.profileV0.Profile(new_stack)
