...
seaice.core.corestack.discretize_profile(profile, y_bins, display_figure=display_figure, fill_gap=fill_gap,
...
def scale_profile(profile, h_ice_f):
    ...
    # TODO better check ice core lenth and ice thickness
