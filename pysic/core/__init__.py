...
# # def import_ic_path(ic_path, ic_property=None, drop_empty=False, fill_missing=True):
# #     """
# #     :param ic_path:
...
# #         logger.warning('%s: check if ice freeboard is reported in cm rather than m' % name)
# #
# #     core = Core.Core(name, date, campaign, lat_start_deg, lon_start_deg, l_c, h_i, h_f, snow_depth)
# #
# #     # Temperature values
...
# #             if sheet == 'snow':
# #                 profile = read_snow_profile(ws_property, ic_property=None, version=version, reference_d=reference_d, fill_missing=True)
# #                 matter = 'snow'
# #             elif sheet == 'seawater':
# #                 profile = read_generic_profile(ws_property, ic_property=None, version=version, reference_d=reference_d, core_length=core.length, fill_missing=fill_missing)
# #                 matter = 'seawater'
...
# #
# #         _imported_variables = []
# #         property_2_sheet = {'salinity': 'salo18', 'salo18': 'salo18'}
# #         for ic_prop in ic_property:
# #             if property_2_sheet[ic_prop] in sheets and ic_prop not in _imported_variables:
# #                 sheet = property_2_sheet[ic_prop]
# #                 ws_property = wb[sheet]
# #                 #variable2import = [var for var in variables if var in inverse_dict(variable_2_sheet)[sheet]]
# #                 if sheet == 'snow':
# #                     profile = read_generic_profile(ws_property, ic_property=None, version=version, reference_d=reference_d)
# #                     matter = 'snow'
# #                 elif sheet == 'seawater':
# #                     matter = 'seawater'
# #                     profile = read_generic_profile(ws_property, ic_property=None, version=version, reference_d=reference_d)
...
# #                 if not profile.empty:
# #                     core.add_profile(profile)
# #                     logger.info('(%s) data imported with success: %s' % (core.name, profile.get_property(True)))
# #                 else:
# #                     logger.info('(%s) no data to import from %s ' % (core.name, sheet))
...
# #
# #
# # def read_generic_profile(ws_property, ic_property=None, version=__CoreVersion__, reference_d={'ice': ['ice surface', 'down']}, core_length=np.nan, fill_missing=True):
# #     """
# #     :param ws_property:
...
#
#
# # def read_snow_profile(ws_property, ic_property=None, version=__CoreVersion__, reference_d={'ice': ['ice surface', 'down']}):
# #     """
# #     :param ws_property:
# #         openpyxl.worksheet
# #     :param variables:
